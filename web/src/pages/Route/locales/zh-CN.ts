...
export default {
  ...
  'page.route.configuration.host.rules.required.placeholder': '请输入 HTTP 请求域名',
  ...
  'page.route.data_loader.types.yaml_config': 'YAML 資料集',
  ...
  'page.route.data_loader.labels.yaml_config_override_method': '刪除配置',
